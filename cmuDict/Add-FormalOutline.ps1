...
Function ConvertTo-FormalGreggOutline {
    ...
    $pronunciation = $pronunciation -creplace 'K AA1 R ?\b', 'kr'	#car is not kor
    ...
    $pronunciation = $pronunciation -creplace 'K ER1 ?\b', 'kur'	#cur is not kr
    ...
    $pronunciation = $pronunciation -creplace 'B IH1 Z N AH0 S ?\b', 'bs'
    ...
    $pronunciation = $pronunciation -creplace 'F AA1 R ?\b', 'fa'
    ...
    #$pronunciation = $pronunciation -creplace 'R AA1 ?\b', 'ro'
    #$pronunciation = $pronunciation -creplace 'R IH0 ?\b', 're'
    ...
    $pronunciation = $pronunciation -creplace 'F ER0 ?\b', 'f'
    $pronunciation = $pronunciation -creplace 'AO1 L ?\b', 'o'
    $pronunciation = $pronunciation -creplace 'AH0 Z ?\b', 's'
    $pronunciation = $pronunciation -creplace 'ZZ1 ?\b', 'eve'
    ...
    $straightStrokes = '(M|N|T|D|JH|CH|SH|m|n|t|d|j|c|z)'
    ...
    $pronunciation = $pronunciation -creplace '^IH0 K S ?\b', 'es'
    if ($word -cmatch '^i') {
