...
class Key_Input:
    ...
    def __init__(self, key_queue, comms_proxy):
        ...
        self.CHORD_MAP = {
            ...
            "plus+1": {"keys": 2, "backspaces": 1, "function": "output_password_a"},
            "plus+2": {"keys": 2, "backspaces": 1, "function": "output_username_password_a"},
            "plus+3": {"keys": 2, "backspaces": 1, "function": "output_username_a"},
            "plus+4": {"keys": 2, "backspaces": 1, "function": "output_password_b"},
            "plus+5": {"keys": 2, "backspaces": 1, "function": "output_username_password_b"},
            "plus+6": {"keys": 2, "backspaces": 1, "function": "output_username_b"},
            "plus+7": {"keys": 2, "backspaces": 1, "function": "output_password_c"},
            "plus+8": {"keys": 2, "backspaces": 1, "function": "output_username_password_c"},
            "plus+9": {"keys": 3, "backspaces": 1, "function": "output_username_c"},
