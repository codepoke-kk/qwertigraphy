...
class Key_Input:
    ...
    def __init__(self, key_queue, comms_proxy):
        ...
        self.CHORD_MAP = {
            ...
            "h+1": {"keys": 2, "backspaces": 1, "function": "focus_tab", "params": 'Settings'},
            "h+2": {"keys": 2, "backspaces": 1, "function": "focus_tab", "params": 'Editor'},
            "h+3": {"keys": 2, "backspaces": 1, "function": "focus_tab", "params":  'Log'},
            "h+4": {"keys": 2, "backspaces": 1, "function": "focus_tab", "params":  'Coach'},
            "h+5": {"keys": 2, "backspaces": 1, "function": "gregg_dict_lookup_word"},
